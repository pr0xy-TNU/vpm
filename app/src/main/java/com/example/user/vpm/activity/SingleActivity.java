package com.example.user.vpm.activity;
...
import com.example.user.vpm.common.User;
import com.example.user.vpm.common.UserAdapter;
import com.example.user.vpm.common.UserTable;
import com.example.user.vpm.database.DbHelper;
